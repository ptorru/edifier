...
pub fn dsp() -> Edif {
        ...
        Cell {
            ...
            views: CellViews(vec![CellView {
                ...
                interface: CellInterface(vec![
                    ...
                    InterfacePort::new(PortToken::new_array("ACOUT", "ACOUT[29:0]", 30), PortDirection::Output),
                    InterfacePort::new(PortToken::new_array("BCOUT", "BCOUT[17:0]", 18), PortDirection::Output),
                    InterfacePort::new(PortToken::new_array("CARRYOUT", "CARRYOUT[3:0]", 4), PortDirection::Output),
                    InterfacePort::new(PortToken::new_array("PCOUT", "PCOUT[47:0]", 48), PortDirection::Output),
                    InterfacePort::new(PortToken::new_array("P", "P[47:0]", 48), PortDirection::Output),
                    InterfacePort::new(PortToken::new_array("XOROUT", "XOROUT[7:0]", 8), PortDirection::Output),
                    InterfacePort::new(PortToken::new_array("ACIN", "ACIN[29:0]", 30), PortDirection::Input),
                    InterfacePort::new(PortToken::new_array("ALUMODE", "ALUMODE[3:0]", 4), PortDirection::Input),
                    InterfacePort::new(PortToken::new_array("A", "A[29:0]", 30), PortDirection::Input),
                    InterfacePort::new(PortToken::new_array("BCIN", "BCIN[17:0]", 18), PortDirection::Input),
                    InterfacePort::new(PortToken::new_array("B", "B[17:0]", 18), PortDirection::Input),
                    InterfacePort::new(PortToken::new_array("CARRYINSEL", "CARRYINSEL[2:0]", 3), PortDirection::Input),
                    InterfacePort::new(PortToken::new_array("C", "C[47:0]", 48), PortDirection::Input),
                    InterfacePort::new(PortToken::new_array("D", "D[26:0]", 27), PortDirection::Input),
                    InterfacePort::new(PortToken::new_array("INMODE", "INMODE[4:0]", 5), PortDirection::Input),
                    InterfacePort::new(PortToken::new_array("OPMODE", "OPMODE[8:0]", 9), PortDirection::Input),
                    InterfacePort::new(PortToken::new_array("PCIN", "PCIN[47:0]", 48), PortDirection::Input),
                ]),
                contents: CellContents(Vec::new()),
                properties: PropertyList::from(Vec::new()),
            }]),
    ...
    let const_net = ContentElement::from(
        ContentNet::new_renamed_with_ports( 
            "&_const0_", 
            "<const0>",
            PortList(vec![                
    ...
    let const1_net = ContentElement::from(
        ContentNet::new_renamed_with_ports( 
            "&_const1_", 
            "<const1>",
            PortList(vec![                
    ...
    let a0_net = ContentElement::from(ContentNet::new_renamed_with_ports("a_0_","a[0]",PortList(vec![PortRef::new_member_with_ref("A", 29, dspref.clone()),PortRef::new_member("a", 7),]),));
    let a1_net = ContentElement::from(ContentNet::new_renamed_with_ports("a_1_","a[1]",PortList(vec![PortRef::new_member_with_ref("A", 28, dspref.clone()),PortRef::new_member("a", 6),]),));
    let a2_net = ContentElement::from(ContentNet::new_renamed_with_ports("a_2_","a[2]",PortList(vec![PortRef::new_member_with_ref("A", 27, dspref.clone()),PortRef::new_member("a", 5),]),));
    let a3_net = ContentElement::from(ContentNet::new_renamed_with_ports("a_3_","a[3]",PortList(vec![PortRef::new_member_with_ref("A", 26, dspref.clone()),PortRef::new_member("a", 4),]),));
    let a4_net = ContentElement::from(ContentNet::new_renamed_with_ports("a_4_","a[4]",PortList(vec![PortRef::new_member_with_ref("A", 25, dspref.clone()),PortRef::new_member("a", 3),]),));
    let a5_net = ContentElement::from(ContentNet::new_renamed_with_ports("a_5_","a[5]",PortList(vec![PortRef::new_member_with_ref("A", 24, dspref.clone()),PortRef::new_member("a", 2),]),));
    let a6_net = ContentElement::from(ContentNet::new_renamed_with_ports("a_6_","a[6]",PortList(vec![PortRef::new_member_with_ref("A", 23, dspref.clone()),PortRef::new_member("a", 1),]),));
    let a7_net = ContentElement::from(ContentNet::new_renamed_with_ports("a_7_","a[7]",PortList(vec![PortRef::new_member_with_ref("A", 22, dspref.clone()),PortRef::new_member("a", 0),]),));
    let b0_net = ContentElement::from(ContentNet::new_renamed_with_ports("b_0_","b[0]",PortList(vec![PortRef::new_member_with_ref("B", 17, dspref.clone()),PortRef::new_member("b", 7),]),));
    let b1_net = ContentElement::from(ContentNet::new_renamed_with_ports("b_1_","b[1]",PortList(vec![PortRef::new_member_with_ref("B", 16, dspref.clone()),PortRef::new_member("b", 6),]),));
    let b2_net = ContentElement::from(ContentNet::new_renamed_with_ports("b_2_","b[2]",PortList(vec![PortRef::new_member_with_ref("B", 15, dspref.clone()),PortRef::new_member("b", 5),]),));
    let b3_net = ContentElement::from(ContentNet::new_renamed_with_ports("b_3_","b[3]",PortList(vec![PortRef::new_member_with_ref("B", 14, dspref.clone()),PortRef::new_member("b", 4),]),));
    let b4_net = ContentElement::from(ContentNet::new_renamed_with_ports("b_4_","b[4]",PortList(vec![PortRef::new_member_with_ref("B", 13, dspref.clone()),PortRef::new_member("b", 3),]),));
    let b5_net = ContentElement::from(ContentNet::new_renamed_with_ports("b_5_","b[5]",PortList(vec![PortRef::new_member_with_ref("B", 12, dspref.clone()),PortRef::new_member("b", 2),]),));
    let b6_net = ContentElement::from(ContentNet::new_renamed_with_ports("b_6_","b[6]",PortList(vec![PortRef::new_member_with_ref("B", 11, dspref.clone()),PortRef::new_member("b", 1),]),));
    let b7_net = ContentElement::from(ContentNet::new_renamed_with_ports("b_7_","b[7]",PortList(vec![PortRef::new_member_with_ref("B", 10, dspref.clone()),PortRef::new_member("b", 0),]),));
    let y0_net = ContentElement::from(ContentNet::new_renamed_with_ports("y_0_","y[0]",PortList(vec![PortRef::new_member_with_ref("P", 47, dspref.clone()),PortRef::new_member("y", 7),]),));
    let y1_net = ContentElement::from(ContentNet::new_renamed_with_ports("y_1_","y[1]",PortList(vec![PortRef::new_member_with_ref("P", 46, dspref.clone()),PortRef::new_member("y", 6),]),));
    let y2_net = ContentElement::from(ContentNet::new_renamed_with_ports("y_2_","y[2]",PortList(vec![PortRef::new_member_with_ref("P", 45, dspref.clone()),PortRef::new_member("y", 5),]),));
    let y3_net = ContentElement::from(ContentNet::new_renamed_with_ports("y_3_","y[3]",PortList(vec![PortRef::new_member_with_ref("P", 44, dspref.clone()),PortRef::new_member("y", 4),]),));
    let y4_net = ContentElement::from(ContentNet::new_renamed_with_ports("y_4_","y[4]",PortList(vec![PortRef::new_member_with_ref("P", 43, dspref.clone()),PortRef::new_member("y", 3),]),));
    let y5_net = ContentElement::from(ContentNet::new_renamed_with_ports("y_5_","y[5]",PortList(vec![PortRef::new_member_with_ref("P", 42, dspref.clone()),PortRef::new_member("y", 2),]),));
    let y6_net = ContentElement::from(ContentNet::new_renamed_with_ports("y_6_","y[6]",PortList(vec![PortRef::new_member_with_ref("P", 41, dspref.clone()),PortRef::new_member("y", 1),]),));
    let y7_net = ContentElement::from(ContentNet::new_renamed_with_ports("y_7_","y[7]",PortList(vec![PortRef::new_member_with_ref("P", 40, dspref.clone()),PortRef::new_member("y", 0),]),));
